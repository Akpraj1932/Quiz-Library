                ...
                <div class="right_col" role="main">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Create Ebook Sub Category 2</h2>
                                    <div class="clearfix"></div>
                                </div>
                                <div class="x_content">
                                    <div class='row'>
                                        <div class='col-md-12'>
                                            <form id="category_form" method="POST" action="addlzsub_2category.php" class="form-horizontal form-label-left" enctype="multipart/form-data">
                                                <input type="hidden" id="add_subcategory2" name="add_subcategory2" required="" value="2" aria-required="true">
                                                <?php
                                        ...
                                        <div class='row'>
                                            ...
                                            <?php } else { ?>
                                                <div class='col-md-4'>
                                                    <?php
                                                    $sql = "SELECT id,`subcategory_name` FROM `subcategory` WHERE language_id=" . $language_id. " ORDER BY id desc";
                                                    $db->sql($sql);
                                                    $categories = $db->getResult();
                                                    ?>
                                                    <select id='filter_category' class='form-control' required>
                                                ...
                                                <table aria-describedby="mydesc" class='table-striped' id='category_list'
                                                    ...
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th scope="col" data-field="sub_2cat_name" data-sortable="true">Sub2Category Name</th>
                ...
                <div class="modal-dialog modal-md" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="myModalLabel">Edit Sub 2 Category</h4>
                        </div>
                        <div class="modal-body">
                            <form id="update_form"  method="POST" action ="db_operations.php" data-parsley-validate class="form-horizontal form-label-left">
                                <input type='hidden' name="update_sub_2category" id="update_sub_2category" value='1'/>
                                <input type='hidden' name="update_sub_2category_id" id="update_sub_2category_id" value=''/>
                                ...
                                <select id="update_maincat_id" name="update_maincat_id" required class="form-control">
                                    <option value=''>Select Options</option>
                                    
                                </select>
                                <label class="" for="subcategory">Sub Category</label>
                                <select id="update_subcategory_id" name="update_subcategory_id" required class="form-control">
                                    <option value=''>Select Options</option>
                                    
                                </select>
                                <div class="form-group">
                                    <label>Sub 2 Category Name</label>
                                    <input type="text" name="update_sub_2cat" id="update_sub_2cat" placeholder="Sub 2 Category Name" class="form-control" required>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div id="status" class="btn-group" >
                                            <label class="btn btn-default" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                                                <input type="radio" name="update_status" value="0">  Deactive 
                                            </label>
                                            <label class="btn btn-primary" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                                                <input type="radio" name="update_status" value="1"> Active
                                            </label>
                                        </div>
                                    </div>
                                </div>
        ...
        <script>
            window.actionEvents = {
                'click .edit-subcategory': function (e, value, row, index) {
                    ...
                    $('#update_sub_2category_id').val(row.id);
                    $('#update_sub_2cat').val(row.sub_2cat_name);
...
<?php if ($fn->is_language_mode_enabled()) { ?>
                ...
                $('#maincat_id').on('change',function(e){
                 ...
                 $('#update_maincat_id').on('change',function(e){
                  var maincat_id = $('#update_maincat_id').val();
                  $.ajax({
                     type:'POST',
                     url:"db_operations.php",
                     data: 'get_subcategories_of_categories=1&maincat_id='+maincat_id+'&type='+type,
                     beforeSend:function(){
                         $('#update_subcategory_id').html('Please Wait..');
                     },
                     success:function(result){
                         $('#update_subcategory_id').html(result);
                        //  console.log(result);
                     }
                  });
                });
            ...
            $(document).on('click', '.delete-subcategory', function () {
                if (confirm('Are you sure? Want to delete sub category? All related questions will also be deleted')) {
                    ...
                    $.ajax({
                        url: 'db_operations.php',
                        type: "get",
                        data: 'id=' + id + '&image=' + image + '&delete_sub_new2category=1&type='+<?=$type?>,
                        success: function (result) {
                            if (result == 1) {
