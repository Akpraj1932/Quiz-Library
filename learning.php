...
<html lang="en">
    <head>
        ...
        <title>Question & Answer | <?= ucwords($_SESSION['company_name']) ?> - Admin Panel </title>
                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <form id="register_form" method="POST" action="db_operations.php" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="novalidate">
                                        ...
                                        <input type="hidden" id="status" name="status" required value="1" aria-required="true">
                                        ...
                                        <?php } ?>
                                         <div class="form-group row">
                                            ...
                                            <!--    <label>Sub 3 Category</label>-->
                                            <!--    <select id="sub_3category" name="sub_3category" required class="form-control">-->
                                            <!--        <option>Select Sub 3 Category</option>-->
                                            <!--    </select>-->
                                            <!--</div>-->
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-md-12 col-sm-12">
                                                ...
                                                <input name="title" type="text" placeholder="Enter Question" require class="form-control"/>
                                            </div>
                                        </div>
                                        <div class="form-group row">                                               
                                            <div class="col-md-12 col-sm-12">
                                ...
                                <div class='row'>
                                    <div class='col-md-12'>
                                        <h2>Question & Answer <small>View / Update / Delete</small></h2>
                                    </div>
                                    <div class='col-md-12'>
                                ...
                                <table aria-describedby="mydesc" class='table-striped' id='learnings'
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <?php } ?>
                                            <th scope="col" data-field="title" data-sortable="true">Question</th>
                    ...
                    $.ajax({
                        ...
                        success: function (result) {
                            if (result == 1) {
                                ...
                                ("Could not delete learning. Try again!");
                            }
             ...
             $(document).ready(function(){
              $("#category").on('change',function(){
                ...
                $.ajax({
                   ...
                   data:"getqasubcategory=1&id="+id+"&type="+type,
                   dataType:"html",
            ...
            $(document).ready(function(){
                $("#subcategory").on("change",function(){
                    ...
                    $.ajax({
                        method:"POST",
                        url:"getsubcategory.php",
                        data:"getqasub2category=1&id="+id+"&type="+type,
                        dataType:"html",
                        success:function(data){
            ...
            $(document).ready(function(){
                $("#sub_2category").on("change",function(){
                    ...
                    $.ajax({
                        method:"POST",
                        url:"getsubcategory.php",
                        data:"getqasub3category=1&id="+id+"&type="+type,
                        dataType:"html",
                        success:function(data){
