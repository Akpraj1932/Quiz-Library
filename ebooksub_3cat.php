                ...
                <div class="right_col" role="main">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Create Ebook Sub Category 3</h2>
                                    ...
                                    <div class='row'>
                                        <div class='col-md-12'>
                                            <form id="category_form" method="POST" action="addlzsub_3category.php" class="form-horizontal form-label-left" enctype="multipart/form-data">
                                                <input type="hidden" id="add_subcategory2" name="add_subcategory3" required="" value="3" aria-required="true">
                                                <?php
        ...
        <script>
            ...
            $(document).ready(function(){
              ...
              $("#delete_multiple_sub_3cat").on('click',function(){
                if (confirm("Are you sure you want to delete all  subcategory 3 ?")){
                $.ajax({
                   method:"POST",
                   url:"deletebook.php",
                   data:"delete_ebook_sub_3cat=1&type="+type,
                   datatype:"html",
                   success:function(data){
                    $("#getlzsub_3category").html(data);
                   }
