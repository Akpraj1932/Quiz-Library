...
<html lang="en">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <div class="row">
                                        <form id="register_form" method="POST" action="addlzebook.php" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="novalidate">
                                            <h4 class="col-md-offset-1"><strong>Create a Question</strong></h4>
                                            <input type="hidden" id="type" name="type" required="" value="2" aria-required="true">
                                            <?php
                                        ...
                                        <div class="form-group">
                                                    ...
                                                    <div class="col-md-10 col-sm-6 col-xs-12">
                                                    <input type="file" id="updf" name="updf" class="form-control" aria-required="true" required><span id="span"></span>
                                                </div>
                                                </div>
  ...
  <thead>
    <tr>
      ...
      <th class="th-sm">Pdf File
      </th>
    </tr>
  </thead>
  <tbody id="getlzallebook">
  </tbody>
                                    </table>
                                </div>
                            </div>
             ...
             $(document).ready(function(){
              $("#language_id").on('change',function(){
                ...
                $.ajax({
                   ...
                   data:"lzcategory=1&id="+language_id+"&type="+type,
                   dataType:"html",
           ...
           $(document).ready(function(){
               $("#category").on('change',function(){
                   ...
                   $.ajax({
                       method:"POST",
                       url:"getsubcategory.php",
                       data:"lzsub=1&id="+category_id+"&type="+type,
                       dataType:"html",
                       success:function(data){
       ...
       <script>
           $(document).ready(function(){
               $('#subcategory').on('change',function(){
                   ...
                   $.ajax({
                       method:"POST",
                       url:"getsubcategory.php",
                       data:"lzsub_2category=1&id="+subcategory_id+"&type="+type,
                       dataType:"html",
                       success:function(data){
           ...
           $(document).ready(function(){
               $('#sub_2category').on('change',function(){
                   var sub_2category_id=$(this).val();
                   var type=<?=$type?>;
                   $.ajax({
                       method:"POST",
                       url:"getsubcategory.php",
                       data:"lzsub_3category=1&id="+sub_2category_id+"&type="+type,
                       dataType:"html",
                       success:function(data){
         ...
         <script>
            ...
            $.ajax({
                  method:"POST",
                  url:"getsubcategory.php",
                  data:"getlzebook=1&type="+type,
                  datatype:"html",
                  success:function(data){
                    $("#getlzallebook").html(data);
                  }
             });
            });
        </script>
