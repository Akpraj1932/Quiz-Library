                ...
                <div class="right_col" role="main">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Create Ebook Sub Category</h2>
                                    <div class="clearfix"></div>
                                </div>
                                <div class="x_content">
                                    <div class='row'>
                                        <div class='col-md-12'>
                                            <form id="category_form" method="POST" action="addlzsubcategory.php" class="form-horizontal form-label-left" enctype="multipart/form-data">
                                                <input type="hidden" id="add_subcategory" name="add_subcategory" required="" value="3" aria-required="true">
                                                <?php
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="update_form"  method="POST" action ="db_operations.php" data-parsley-validate class="form-horizontal form-label-left">
                                <input type='hidden' name="update_subcategory" id="update_subcategory" value='2'/>
...
<?php } ?>
        ...
        <script>
            $(document).on('click', '.delete-subcategory', function () {
                    ...
                    $.ajax({
                        url: 'db_operations.php',
                        type: "get",
                        data: 'id=' + id + '&image=' + image + '&delete_subcategory=1&type='+<?=$type?>,
                        success: function (result) {
                            if (result == 1) {
            ...
            $('#delete_multiple_subcategories').on('click', function (e) {
             ...
             $(document).ready(function(){
                ...
                $.ajax({
                   ...
                   data:"lzsubcategory=1&type="+type,
                   dataType:"html",
                   success:function(data){
                       $("#getlzsubcategory").html(data);
                   }
                });
            });
        </script>
             ...
             $(document).ready(function(){
              $("#filter_btn").on('click',function(){
                ...
                $.ajax({
                   method:"POST",
                   url:"getsubcategory.php",
                   data:"filterlzsubcategory=1&id="+filter_language+"&category="+filter_category,
                   datatype:"html",
                   success:function(data){
                    $("#getlzsubcategory").html(data);
                   }
   ...
   <script>
            $(document).ready(function(){
                var type=<?=$type?>;
              $("#delete_multiple_subcat").on('click',function(){
                $.ajax({
                   method:"POST",
                   url:"deletebook.php",
                   data:"delete_ebook_subcat=1&type="+type,
                   datatype:"html",
                   success:function(data){
                    $("#getlzsubcategory").html(data);
                   }
