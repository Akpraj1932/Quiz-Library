 ...
 * @Package Database
 */
define('DOMAIN_URL', 'http://localhost/Quiz_7_0_4/');
define('JWT_SECRET_KEY', '1932');
...
class Database {
    ...
    private $db_user = "perfectb_quiz";  // Change as required
    private $db_pass = "Akpraj@1932";  // Change as required 
    private $db_name = "perfectb_onlinequiz"; // Change as required
