                ...
                <div class="right_col" role="main">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Create Ebook Main Category</h2>
                                    <div class="clearfix"></div>
                                </div>
                                <div class="x_content">
                                    <div class='row'>
                                        <div class='col-md-12 col-sm-12'>
                                            <form id="category_form" method="POST" action="addebookcategory.php" class="form-horizontal form-label-left" enctype="multipart/form-data">
                                                <input type="hidden" id="add_category" name="add_category" required="" value="3" aria-required="true">
...
<?php } ?>
            ...
            <script>
             $(document).ready(function(){
                ...
                $.ajax({
                   ...
                   data:"getebookcategory=1&type="+type,
                   dataType:"html",
                   success:function(data){
                       $("#getebookcategory").html(data);
                   }
                });
            });
        </script>
        ...
        //     $(document).ready(function(){
        //         var type=<?=$type?>;
        //       $("#delete_multiple_cat").on('click',function(){
        //         if (confirm("Are you sure you want to delete all category  ?")){
        //         $.ajax({
        //           method:"POST",
        //           url:"deletebook.php",
        //           data:"delete_ebook_cat=1&type="+type,
        //           datatype:"html",
        //           success:function(data){
        //             $("#getebookcategory").html(data);
        //           }
