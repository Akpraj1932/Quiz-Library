...
bottom: .5em;
                ...
                <div class="right_col" role="main">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Create Q/A Sub Category 3</h2>
                                    <div class="clearfix"></div>
                                </div>
                                <div class="x_content">
                                    <div class='row'>
                                        <div class='col-md-12'>
                                            <form id="category_form" method="POST" action="addlzsub_3category.php" class="form-horizontal form-label-left" enctype="multipart/form-data">
                                                <input type="hidden" id="add_subcategory2" name="add_subcategory3" required="" value="2" aria-required="true">
                                                <?php
                                                ...
                                                if ($fn->is_language_mode_enabled()) {
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-6 col-sm-12">
                                                            <label for="sub_2category_id">Sub 2 Category</label>
                                        ...
                                        <div class='row'>
                                            ...
                                            <?php } else { ?>
                                                <div class='col-md-4'>
                                                    <?php
                                                    $sql = "SELECT id,`sub_2category_name` FROM `sub_2category` WHERE language_id=" . $language_id. " ORDER BY id desc";
                                                    $db->sql($sql);
                                                    $categories = $db->getResult();
                                                    ?>
                                                    <select id='filter_category' class='form-control' required>
                                                        ...
                                                        <?php foreach ($categories as $row) { ?>
                                                            <option value='<?= $row['id'] ?>'><?= $row['sub_2category_name'] ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                            <?php } ?>
                                        ...
                                        <div class='col-md-12'>
                                            <div id="toolbar">
                                                <div class="col-md-3">
                                                    <button class="btn btn-danger btn-sm" id="delete_multiple_subcategories" title="Delete Selected Subcategories"><em class='fa fa-trash'></em>All Data</button>
                                                </div>                                                
                                            </div>
  ...
  <thead>
    <tr>
      ...
      <th class="th-sm">Main Category
      </th>
      <th class="th-sm">Sub Category
      </th>
      <th class="th-sm">Sub Category 2
      </th>
      <th class="th-sm">Sub Category 3</th>
      <th class="th-sm">Image
      </th>
      <th class="th-sm">Status</th>
      <th class="th-sm">Total Question</th>
      <th class="th-sm">Operate</th>
    </tr>
  </thead>
  <tbody id="getlzsub_3category">
  </tbody>
        ...
        <script>
             $(document).ready(function(){
              $("#language_id").on('change',function(){
                var filter_language=$('#language_id').val();
                var type=<?=$type?>;
                $.ajax({
                   method:"POST",
                   url:"getsubcategory.php",
                   data:"glzsub_2category=1&id="+filter_language+"&type="+type,
                   dataType:"html",
                   success:function(data){
             ...
             $(document).ready(function(){
                ...
                $.ajax({
                   method:"POST",
                   url:"getsubcategory.php",
                   data:"getlzsub_3category=1&type="+type,
                   dataType:"html",
                   success:function(data){
                       $("#getlzsub_3category").html(data);
                   }
                });
            });
        </script>
