                                    ...
                                    <div class='row'>
                                        <div class='col-md-12 col-sm-12'>
                                            <form id="category_form" method="POST" action="db_operations.php" class="form-horizontal form-label-left" enctype="multipart/form-data">
                                                <input type="hidden" id="add_banner_image" name="add_banner_image" required="" value="1" aria-required="true">
                                                ...
                                                <div class="form-group">
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <button type="submit" id="submit_btn" class="btn btn-warning">Add Banner</button>
                                                    </div>
                                                </div>
                                            </form>
                                        ...
                                        <div class='col-md-12 col-sm-12'>
                                            ...
                                            <div class='row'>
                                                ...
                                                <table aria-describedby="mydesc" class='table-striped' id='category_list'
                                                       data-toggle="table" data-url="get-list.php?table=banner_image"
                                                    ...
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th scope="col" data-field="title" data-sortable="false">Link</th>
        ...
        <script>
            $(document).on('click', '.delete-subcategory', function () {
                    ...
                    $.ajax({
                        url: 'db_operations.php',
                        type: "get",
                        data: 'id=' + id + '&image=' + image + '&delete_banner_image=1',
                        success: function (result) {
                            if (result == 1) {
                                $('#category_list').bootstrapTable('refresh');
                            } else
