                                    ...
                                    <div class='row'>
                                        <div class='col-md-12'>
                                            <form id="category_form" method="POST" action="db_operations.php" class="form-horizontal form-label-left" enctype="multipart/form-data">
                                                <input type="hidden" id="add_subcategory2" name="add_subcategory2" required="" value="6" aria-required="true">
                                                <?php
                                        ...
                                        <div class='row'>
                                            ...
                                            <!--</div>-->
                                            <div class='col-md-3'>
                                                <button class='btn btn-primary btn-block' id='filter_btn'>Filter 2 Subcategory</button>
                                            </div>
                                            <div class='col-md-12'><hr></div>
                                        </div>
                                        <div class='col-md-12'>
