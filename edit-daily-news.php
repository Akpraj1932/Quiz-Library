...
$where = 'WHERE s.id='.$id;  
    ...
    $sql = "SELECT s.*, l.language, c.`category_name` " . $total_question . " FROM `dailynews` s " . $left_join . " " . $where;
    $db->sql($sql);
    $res = $db->getResult();
                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <form id="category_form" method="POST" action="db_operations.php" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="novalidate">
                                            <input type="hidden" name="update_dailynews" value="1">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-1">
                                                    <button type="submit" id="submit_btn" class="btn btn-success">Update News</button>
                                                </div>
                                            </div>
                                            </form>
